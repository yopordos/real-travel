...
export const es: LandingCopy = {
  ...
  products: {
    ...
    items: [
      {
        id: 'web-app-destino',
        badge: 'Dentro de Real Travel',
        segment: 'Destinos',
        name: 'Destino en la web-app de Real Travel',
        audience: 'Municipios, oficinas de turismo, cámaras y regiones.',
        pitch: 'Tu destino publicado dentro de realtravelapp.com, junto al resto de destinos, con tus puntos, rutas y prestadores.',
        detailTitle: 'Destino en la web-app de Real Travel',
        detailAudience: 'Para municipios, oficinas de turismo, cámaras y regiones.',
        includesTitle: 'Qué incluye — vive dentro de realtravelapp.com',
        includes: [
          'Tu destino dentro de la web-app de Real Travel, sin dominio propio',
          'Carga profesional de puntos, rutas y prestadores',
          'Diseño y funcionamiento ya construidos: no se desarrolla nada',
          'Alojamiento, puesta en marcha y configuración inicial',
        ],
        benefits: [
          'Presencia digital inmediata, sin inversión en desarrollo propio',
          'Te ven los viajeros que ya usan Real Travel en otros destinos',
          'Contenido turístico organizado y navegable',
          'Todo administrado por Real Travel: no gestionas tecnología',
        ],
        note: 'La opción más rápida y económica. Si necesitas dominio e identidad propios, mira la web-app propia del destino.',
      },
      {
        id: 'web-destino-personalizado',
        badge: 'Dominio propio',
        segment: 'Destinos',
        name: 'Web-app propia del destino',
        audience: 'Destinos que quieren identidad y dominio propios.',
        pitch: 'Tu propia web-app, con tu dominio y tu imagen, conectada a Real Travel en vez de alojada dentro.',
        detailTitle: 'Web-app propia del destino',
        detailAudience: 'Para destinos que quieren identidad y dominio propios.',
        ...
        note: 'La diferencia con la anterior: aquí el destino tiene dominio y web propios; allí vive dentro de realtravelapp.com.',
      },
      {
        id: 'prestador',
...
export const en: LandingCopy = {
  ...
  products: {
    ...
    items: [
      {
        id: 'web-app-destino',
        badge: 'Inside Real Travel',
        segment: 'Destinations',
        name: 'Destination inside the Real Travel web app',
        audience: 'Municipalities, tourism offices, chambers and regions.',
        pitch: 'Your destination published inside realtravelapp.com, alongside the others, with your places, routes and providers.',
        detailTitle: 'Destination inside the Real Travel web app',
        detailAudience: 'For municipalities, tourism offices, chambers and regions.',
        includesTitle: 'What it includes — lives inside realtravelapp.com',
        includes: [
          'Your destination inside the Real Travel web app, with no domain of its own',
          'Professional loading of places, routes and providers',
          'Design and inner workings already built: nothing to develop',
          'Hosting, launch and initial setup',
        ],
        benefits: [
          'Immediate digital presence, with no development investment',
          'Seen by travellers already using Real Travel in other destinations',
          'Tourism content organised and easy to browse',
          'All run by Real Travel: you don’t manage technology',
        ],
        note: 'The fastest and cheapest option. If you need your own domain and identity, see the destination’s own web app.',
      },
      {
        id: 'web-destino-personalizado',
        badge: 'Own domain',
        segment: 'Destinations',
        name: 'The destination’s own web app',
        audience: 'Destinations that want their own identity and domain.',
        pitch: 'Your own web app, under your domain and your look, connected to Real Travel instead of hosted inside it.',
        detailTitle: 'The destination’s own web app',
        detailAudience: 'For destinations that want their own identity and domain.',
        ...
        note: 'The difference with the previous one: here the destination has its own domain and web app; there it lives inside realtravelapp.com.',
      },
      {
        id: 'prestador',
        badge: 'Free to join',
