    ...
    items: [
      {
        ...
        pitch: 'Tu propia web-app, con el dominio y la identidad del destino, autoadministrable desde el primer día.',
    ...
    items: [
      {
        ...
        pitch: 'Your own web app, under the destination’s domain and identity, self-managed from day one.',
